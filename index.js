...
// pinpoint-node-agnet 에서 outgoingRequest 잡힘
app.get('/', function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get('https://naver.com')];
            case 1:
                response = _a.sent();
...
// pinpoint-node-agnet 에서 outgoingRequest 안잡힘
app.get('/complex', function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            case 0:
                requestConfig = {
                    method: 'GET',
                    headers: {},
                    url: urijs_1.default('https://naver.com').href(),
                    timeout: 5000,
